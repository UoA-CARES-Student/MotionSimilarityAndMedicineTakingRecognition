# this script is used to preprocess the dataset videos
# cut the videos into frames and rezise to fit the input of VGG16
import pandas as pd
import numpy as np
...
TARGET = 'dataset/Class1' # Class 1 for drinking water
NORMAL_PATH = 'dataset/Class2/' # class 2 for taking medicine
